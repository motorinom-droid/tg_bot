...
TOKEN_PRANK = "7685968755:AAGmfxpSBIBtXGQAJIbM-c9Z0FdKIuHEnxs"  # От @BotFather
# TG_ID = 410404143  # Мой Telegram ID
TG_ID = 5378999070  # Её Telegram ID (узнать через @userinfobot)

bot = Bot(token=TOKEN_PRANK)
dp = Dispatcher()
